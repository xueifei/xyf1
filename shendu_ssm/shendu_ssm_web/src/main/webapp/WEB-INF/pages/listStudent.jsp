				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<!--工具栏/-->
							<form action="${pageContext.request.contextPath}/student/editStuClassBatch"
								  method="post">
							<!--数据列表-->
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${list}" var="s">
										<tr>
											<td><input name="studentIds" type="checkbox" value="${s.id }"></td>
											<td>${s.id }</td>
											<td>${s.name }</td>
											<td>${s.address}</td>
											<td>${s.stuClass}</td>
					...
					<shiro:authenticated>
						...
						<div class="box-tools text-center">
							<button type="submit" class="btn bg-maroon" >批量修改班级</button>
						</div>
						<!--工具栏/-->
			<!-- 正文区域 /-->
			</form>
